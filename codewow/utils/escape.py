...
def json_encode(value):
    ...
    return _json_encode(recursive_unicode(value), cls=JSONDateTimeEncoder).replace("</", "<\\/")


def json_decode(value):
    """Returns Python objects for the given JSON string."""
    #return _json_decode(to_basestring(value))
    return _json_decode(to_basestring(value), object_hook=datetime_decoder)
